...
const ruleSections = [
  {
    title: "基本ルール",
    items: [
      "このアプリは、商品ごとに問題を作って LINE で復習するための学習アプリです。",
  ...
  },
  {
    title: "問題登録ルール",
    items: [
      "商品名は後から見返して分かる名前で入れます。LINE の問題見出しにも表示されます。",
      "問題文には相場や売値を思い出すための問いを書き、解答には答えをそのまま入れます。",
      "画像は問題文用と解答用に分けて登録できます。複数枚ある場合はまとめて選択して問題ありません。",
      "自動送信を ON にすると、復習対象日に LINE へ自動送信されます。",
    ],
  },
  {
    title: "LINE返信ルール",
    items: [
      "問題メッセージにリプで「解答」と送ると、解答を表示します。",
  ...
  },
  {
    ...
    items: [
      ...
      "管理画面の手動送信を押すと、その場で LINE に問題を送れます。",
  ...
  },
  {
    title: "運用時の注意",
    items: [
      "LINE の返信は、できるだけ bot から届いた最新メッセージに対して行ってください。",
...
export default function RulesPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="アプリのルール"
        description="このアプリの使い方、LINE返信ルール、日々の運用ルールをまとめています。"
      />
